 ...
 * </ul>
 */
public class EmbeddedAgArch implements Runnable, AgArchInfraTier {

	protected EmbeddedEnvironment    infraEnv     = null;
    private EmbeddedExecutionControl infraControl = null;
    ...
    protected Logger        logger  = Logger.getLogger(EmbeddedAgArch.class.getName());
     ...
     * the TS.
     */
    public void initAg(String agArchClass, String agClass, ClassParameters bbPars, String asSrc, Settings stts, RunEmbeddedMAS masRunner) throws JasonException {
        try {
    ...
    void initAg(String agArchClass, Agent ag, RunEmbeddedMAS masRunner) throws JasonException {
        try {
            this.masRunner = masRunner; 
            userAgArch = (AgArch) Class.forName(agArchClass).newInstance();
            userAgArch.setArchInfraTier(this);
    ...
    public void setLogger() {
        logger = Logger.getLogger(EmbeddedAgArch.class.getName() + "." + getAgName());
    ...
    public void setEnvInfraTier(EmbeddedEnvironment env) {
        infraEnv = env;
    }

    public EmbeddedEnvironment getEnvInfraTier() {
        return infraEnv;
    }

    public void setControlInfraTier(EmbeddedExecutionControl pControl) {
        infraControl = pControl;
    }

    public EmbeddedExecutionControl getControlInfraTier() {
        return infraControl;
    }
    ...
    public void sendMsg(Message m) throws ReceiverNotFoundException {
        ...
        EmbeddedAgArch rec = masRunner.getAg(m.getReceiver());
