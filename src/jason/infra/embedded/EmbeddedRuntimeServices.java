...
public class EmbeddedRuntimeServices implements RuntimeServicesInfraTier {

    private static Logger logger = Logger.getLogger(EmbeddedRuntimeServices.class.getName());
    
    private RunEmbeddedMAS masRunner;
    
    public EmbeddedRuntimeServices(RunEmbeddedMAS masRunner) {
    ...
    public boolean createAgent(String agName, String agSource, String agClass, String archClass, ClassParameters bbPars, Settings stts) throws Exception {
        ...
        EmbeddedAgArch agArch = new EmbeddedAgArch();
